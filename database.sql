SELECT * FROM abc.user;CREATE TABLE `category` (
...
CREATE TABLE `promotion_products` (
  ...
  KEY `FKfbxwphn4my3fb4h46sgue57ns` (`products_id`),
  KEY `FKpetrd1fg2eng8pm4kyucq0r3d` (`promotion_id`),
  CONSTRAINT `FKfbxwphn4my3fb4h46sgue57ns` FOREIGN KEY (`products_id`) REFERENCES `product` (`id`),
  CONSTRAINT `FKpetrd1fg2eng8pm4kyucq0r3d` FOREIGN KEY (`promotion_id`) REFERENCES `promotion` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),CREATE TABLE `users_roles` (
